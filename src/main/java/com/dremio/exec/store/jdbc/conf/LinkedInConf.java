...
@SourceType(value = "LinkedInARP", label = "LinkedIn",uiConfig = "linkedin-layout.json")
public class LinkedInConf extends AbstractArpConf<LinkedInConf> {
  private static final String ARP_FILENAME = "arp/implementation/linkedin-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.linkedin.LinkedInDriver";
